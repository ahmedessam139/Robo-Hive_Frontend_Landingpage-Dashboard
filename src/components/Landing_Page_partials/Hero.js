...
export default function Hero() {
    ...
    return (
        <>
            <section id="home" className="relative z-9 overflow-hidden pt-[120px] pb-16 md:pt-[150px] md:pb-[120px] xl:pt-[180px] xl:pb-[160px] 2xl:pt-[210px] 2xl:pb-[200px] " >
                <div className="flex justify-center items-center">
                    <div className="flex items-center justify-center">
                        <div className="w-full px-4">
                            <div className="wow fadeInUp mx-auto max-w-[800px] text-center" >
                                <Typography variant="h4" color="text.primary" fontWeight={700}>
                                    Revolutionize your business processes with ROBO-HIVE{' '}
                                    <Typed
                                        strings={[' - the ultimate efficiency booster']}
                                        typeSpeed={50}
                                        loop={false}
                                        className="text-blue-500"
                                    />
                                </Typography>
                                <Typography variant="body1" color="text.primary" fontWeight={600} mt={4}>
