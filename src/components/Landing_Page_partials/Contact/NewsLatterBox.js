const NewsLatterBox = () => {
  return (
    <div
      className="wow fadeInUp relative z-5 rounded-md bg-slate-100 p-8  sm:p-11 lg:p-8 xl:p-11"
      data-wow-delay=".2s"
    >
      <h3 className="mb-4 text-2xl font-bold leading-tight text-black-500">
        Subscribe to receive future updates
      </h3>
      <p className="mb-11 border-b border-blue-400 border-opacity-25 pb-11 text-base font-medium leading-relaxed text-gray-400">
      Subscribe now to stay informed of any future updates.
      ...
      <form>
        <input
          ...
          className="mb-4 w-full rounded-md border border-blue-400 border-opacity-10 py-3 px-6 text-base font-medium text-blue-400 placeholder-gray-400 outline-none focus:border-blue-500 focus:border-opacity-100 focus-visible:shadow-none "
        />
        <input
          type="email"
          name="email"
          placeholder="Enter your email"
          className="mb-4 w-full rounded-md border border-blue-400 border-opacity-10 py-3 px-6 text-base font-medium text-blue-400 placeholder-gary-400 outline-none focus:border-blue-500 focus:border-opacity-100 focus-visible:shadow-none "
        />
        <input
          type="submit"
          value="Subscribe"
          className="duration-80 mb-4 w-full cursor-pointer rounded-md border border-transparent bg-blue-500 py-3 px-6 text-center text-base font-medium text-white outline-none transition ease-in-out hover:bg-opacity-80 hover:shadow-signUp focus-visible:shadow-none"
        />
        <p className="text-center text-base font-medium leading-relaxed text-gray-400">
