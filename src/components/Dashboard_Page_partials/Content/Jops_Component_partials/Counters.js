        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="col-span-1 bg-gradient-to-r from-red-500 to-pink-500 text-white rounded-lg shadow-lg">
            <div className="p-4">
              ...
              <h6 className="text-xs font-medium">Total jobs</h6>
            </div>
          </div>
          <div className="col-span-1 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-lg shadow-lg">
            <div className="p-4">
              ...
              <h6 className="text-xs font-medium">Pending jobs</h6>
            </div>
          </div>
          <div className="col-span-1 bg-gradient-to-r from-green-500 to-lime-500 text-white rounded-lg shadow-lg">
            <div className="p-4">
              ...
              <h6 className="text-xs font-medium">Executed jobs</h6>
            </div>
          </div>
          <div className="col-span-1 bg-gradient-to-r from-gray-500 to-gray-700 text-white rounded-lg shadow-lg">
            <div className="p-4">
              ...
              <h6 className="text-xs font-medium">Failed jobs</h6>
            </div>
          </div>
        </div>
      </div>
